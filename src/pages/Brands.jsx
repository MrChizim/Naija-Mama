      ...
      <section style={{ position: 'relative', overflow: 'hidden', minHeight: 'clamp(480px,60vh,640px)', display: 'flex', alignItems: 'flex-end' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: 1200, margin: '0 auto', padding: '0 clamp(20px,5vw,80px) clamp(48px,7vw,80px)' }}>
          ...
          <div style={{
            ...
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="var(--amber-soft)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%,340px),1fr))', gap: 'clamp(40px,6vw,80px)', alignItems: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            {[
              {
                icon: (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--amber-soft)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/>
                  </svg>
                ),
                title: 'Brand listing in our directory',
                sub: 'Your logo, tagline, tags, and website link',
              },
              {
                icon: (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--amber-soft)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                ...
                title: 'Sponsored community posts',
                sub: "Reach mamas where they're already talking",
              },
              {
                icon: (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--amber-soft)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                ...
                sub: 'See clicks, impressions, and enquiries',
              },
              {
                icon: (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--amber-soft)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                ...
                sub: 'Top visibility in your category (12-month plan)',
              },
            ].map(item => (
              <div key={item.title} style={{
                ...
                <div style={{ width: 36, height: 36, borderRadius: 10, background: 'rgba(213,176,216,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  {item.icon}
                </div>
                <div>
